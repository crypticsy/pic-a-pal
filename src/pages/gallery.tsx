          ...
          <div className="max-h-[calc(100vh-200px)] overflow-y-auto pr-2">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {photoStrips.map((strip: PhotoStripType, idx: number) => (
                <div key={strip.id} className={`doodle-border-thick p-4 sketch-shadow ${idx % 3 === 0 ? 'rotate-1' : idx % 3 === 1 ? '-rotate-1' : 'rotate-2'} bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 border-gray-800 dark:border-gray-300`}>
                  {/* Photo Strip Preview */}
